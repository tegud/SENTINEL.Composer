...
module.exports = function(config) {
	...
	function LogMessagesPerSec(){
		console.log('Messages per sec: ' + messagesPerSec);
		messagesPerSec = 0;

		setTimeout(functionLogMessagesPerSec, 1000)
	}

	functionLogMessagesPerSec();
